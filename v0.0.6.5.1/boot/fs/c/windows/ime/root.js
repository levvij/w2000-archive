...
const config = {
	...
	ie: {
		...
		bookmarks: [{
			...
			{
				title: "Makis Töffli Homepage",
				url: "https://m152.gibz-informatik.ch/sj17_18/infa3a/team04/index.html"
			},
			{
				title: "dotcdn.us",
				url: "https://dotcdn.us/cover/2019/1/"
			},
		]
	},
	user: {
	...
	extedit: {
		default: "c/windows/levvij/devenv.exe",
		txt: "c/windows/system32/notepad.exe",
		exe: "c/windows/levvij/devenv.exe",
		bat: "c/windows/levvij/devenv.exe",
		cmd: "c/windows/levvij/devenv.exe",
		jpg: "c/windows/system32/paint.exe",
		jpeg: "c/windows/system32/paint.exe",
		gif: "c/windows/system32/paint.exe",
		png: "c/windows/system32/paint.exe",
	...
	fs: {
		...
		icon: {
			...
			"c/windows/system32/notepad.exe": "notepad/0x0001"
		},
		typeName: {
			default: "% File",

...
window.render(ui => {
	...
	applicationGrid[1][0].add(ui.Button("End Task", () => {
		applicationList.selectedItem.process.exit(Process.ExitCode.externallyExited);
	}));
	...
	Event.subscribe(Process.onexit, Process.onstart, Process.onnewwindow, Process.onnewtimer, Process.ontimerstop, () => {

...
<script>
	...
	onload = async () => {
		...
		const installerProcess = await Application.run("c/windows/system32/installer.exe");
		installerProcess.onexit.subscribe(async () => {
			await Application.run("c/windows/system32/services.exe");
